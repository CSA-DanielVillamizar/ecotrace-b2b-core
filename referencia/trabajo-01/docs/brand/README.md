...
Sistema visual de la consola web de la solución de referencia. Usa la misma paleta y tipografía que las presentaciones del curso. La fuente de verdad en código es [`tokens.css`](../../src/EcoTrace.Console/wwwroot/css/tokens.css): si algo de esta guía y ese archivo difieren, manda el archivo.
